...
@Deprecated
class SpongeTextParser implements PlatformFormattingParser<Text> {

	@Override
	public Text colour(String msg) {
		return colourProcessor(msg, ColourPatterns.COLOUR_PATTERN).build();
	}
	...
	@Override
	public Text parseJson(String msg) {
		return parseJsonProcessor(msg, ColourPatterns.COLOUR_PATTERN);
	}
