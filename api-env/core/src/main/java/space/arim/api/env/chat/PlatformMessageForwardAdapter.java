...
/**
 * Converts ArimAPI's {@link SendableMessage} to another API's equivalent class {@code T}. <br>
 * <br>
 ...
 */
public interface PlatformMessageForwardAdapter<T> {
	
	/**
	 * Converts from ArimAPI to the platform specific type.
	 * 
	 ...
	 * code enum are converted to the nearest legacy colour, via {@link PredefinedColour#getNearestTo(int)}
	 * 
