 ...
 *
 */
public interface MessageBuilderFramework {
	 ...
	 * @return the builder
	 */
	MessageBuilderFramework append(Component component);
	 ...
	 * @return the builder
	 */
	MessageBuilderFramework append(Component...components);
	 ...
	 * @return the builder
	 */
	MessageBuilderFramework add(String text);
	 ...
	 * @return the builder
	 */
	MessageBuilderFramework colour(Colour colour);
	 ...
	 * @return the builder
	 */
	MessageBuilderFramework style(Style style);
	 ...
	 * @return the builder
	 */
	default MessageBuilderFramework style(Style style, boolean enable) {
	 ...
	 * @return the builder
	 */
	MessageBuilderFramework unstyle(Style style);
