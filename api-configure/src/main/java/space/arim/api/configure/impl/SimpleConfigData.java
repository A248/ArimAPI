...
public class SimpleConfigData extends BaseConfigData {
	 ...
	 * 
	 * @param values the map of values, see {@link ConfigData#getRawMap()} for requirements
	 * @param commentHeader the list of comments in the header, see {@link ConfigData#getCommentHeader()} for requirements
	 * @throws NullPointerException if either parameter is null
	 */
	public SimpleConfigData(Map<String, Object> values, List<ConfigComment> commentHeader) {
		super(values, commentHeader);
	}
